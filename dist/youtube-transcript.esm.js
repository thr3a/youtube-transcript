    ...
    static fetchTranscript(videoId, config) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const videoPageResponse = yield fetch(`https://www.youtube.com/watch?v=${identifier}`, {
                headers: Object.assign(Object.assign({}, ((config === null || config === void 0 ? void 0 : config.lang) && { 'Accept-Language': config.lang })), { 'User-Agent': USER_AGENT, 'Origin': 'https://www.youtube.com', 'referer': 'https://www.youtube.com/watch?v=0ExzCPCLzYM' }),
            });
